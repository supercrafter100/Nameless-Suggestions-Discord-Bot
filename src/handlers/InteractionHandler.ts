...
export default abstract class InteractionHandler<CollectType extends NonNullable<unknown>> {
    ...
    public async start() {
        if (this.started) return this.logger.error(`Tried to start ${this.constructor.name}, but it already started`);
