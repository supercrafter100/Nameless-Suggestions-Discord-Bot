...
// Import default en_uk type
import type en from '../language/en_UK.json';
const DEFAULT_LANGUAGE = 'en_UK';

export default class LanguageManager {
    public static languages: Collection<string, typeof en> = new Collection();
    ...
    public static loadLanguages(dir: string) {
        ...
        for (const languageFile of languageFiles) {
            ...
            try {
                ...
                LanguageManager.logger.error('Error loading language files', e);
            }
        }
    }

    public static async getString(guildId: string, key: string, ...placeholders: string[]): Promise<string> {
